...
database_name = case Padrino.env
  when :development then 'controle_projetos_development'
  when :production  then 'controle_projetos_production'
  when :test        then 'controle_projetos_test'
end
...
#       default:
#         database: controle_projetos_development
#         hosts:
#           - localhost:27017
#
#   production:
#     clients: #Replace clients with sessions to work with Mongoid version 3.x or 4.x
#       default:
#         database: controle_projetos_production
#         hosts:
#           - localhost:27017
#
#   test:
#     clients: #Replace clients with sessions to work with Mongoid version 3.x or 4.x
#       default:
#         database: controle_projetos_test
#         hosts:
#           - localhost:27017
#
#
